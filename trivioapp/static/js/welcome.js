...
(function(window) {
     ...
     * Akm2.SimplexNoise
     * 
     * Base code jwagner's simplex-noise.js (https://github.com/jwagner/simplex-noise.js)
     * 
     * @see https://github.com/jwagner/simplex-noise.js
...
// forked from Event's "Web Creator's Contest Q the 2nd【vol.2】エントリー用コード" https://jsdo.it/Event/zojr
...
(function() {
     ...
     * コンテンツコンテナの高さを調整する
     * 
     * @param containerHeight 高さの目標値, ウィンドウサイズより小さい場合は反映されない
     */
     ...
     * ナビゲーションの状態を設定する
     * 
     * @param show 表示するか示す, false にした場合は hide クラスセレクタが付与される
     */
